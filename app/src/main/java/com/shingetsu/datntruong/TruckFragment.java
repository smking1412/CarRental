...
import static com.shingetsu.datntruong.HomeActivity.listCar4;
...
public class TruckFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_truck, container, false);
        recyclerView = (RecyclerView) view.findViewById(R.id.recycle_truck);
        miniCarAdapter = new MiniCarAdapter(getActivity(), listCar4);
        ...
        miniCarAdapter.setOnItemClickListener(new MiniCarAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int pos, View v) {
                ...
                intent.putExtra("pid", listCar4.get(pos).getPid());
